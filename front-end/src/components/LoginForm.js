    ...
    const forgotPassword = () => {
        swal({
            ...
            .then((email) => {
                ...
                emailjs.send('service_8m4c5ua', 'template_bixak1k', { email: email }, 'Ig2_KfIjR0_6K51qq')
                    .then((result) => {
            ...
            <div className="form-design">
                <div className="col-1">
                    ...
                    <form id='form' className='flex flex-col' onSubmit={handleSubmit(onSubmit)}>
                        <input name="email_address" type="text" {...register("email_address", { required: true })} placeholder='Email Address' />
                        <input type="text" {...register("password", { required: true })} placeholder='Password' />
                        {errors.email_address && <small className="errorPara">Email is required</small>}
                        {errors.password && <small className="errorPara">Password is required!</small>}
